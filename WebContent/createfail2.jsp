...
<ul>
		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<!-- breadcrumb -->
				<ol class="breadcrumb">
					<li>Administrator</li><li>create merchant</li>
				</ol>
				<!-- end breadcrumb -->
			...
			<div id="content">
				...
				<h1 style="color:red " >Create Failed!</h1>
				<h2 style="color:red " >There is something wrong with the creation!</h2>
				<h2 style="color:red " >The user exists and input a different merchantid or try later! </h2>
				<!-- START ROW -->
					...
					<div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
								...
								<div>
									...
									<div class="widget-body no-padding">
										...
										<s:form action="merchant-create" class="smart-form">									
											...
											<fieldset>										
												...
												<section>
													...
													<label class="input">
														<input type="text" name="mid" value="<%= mid %>" class="input-sm">
													</label>
												</section>		
											  	<section>
													<label class="label">Name</label>
													<label class="input">
														<input type="text" name="name" value="<%= name %>" class="input-sm" >
													</label>
											 	</section>
											 	<section>
													<label class="label">Password</label>
													<label class="input">
														<input type="text" name="pwd" value="<%= pwd %>" class="input-sm" >
													</label>
											 	</section>
											 	<section>
													<label class="label">BankID</label>
													<label class="input">
														<input type="text" name="bankid" value="<%= bankid %>" class="input-sm" >
													</label>
											 	</section>
