										...
										<s:form action="merchant-create" class="smart-form">									
											...
											<fieldset>										
												...
												<section>
													...
													<label class="input">
														<input type="text" name="mid" value="" class="input-sm">
													</label>
												</section>		
											  	<section>
													<label class="label">Name</label>
													<label class="input">
														<input type="text" name="name" value="" class="input-sm" >
													</label>
											 	</section>
											 	<section>
													<label class="label">Password</label>
													<label class="input">
														<input type="text" name="pwd" value="" class="input-sm" >
													</label>
											 	</section>
											 	<section>
													<label class="label">BankID</label>
													<label class="input">
														<input type="text" name="bankid" value="" class="input-sm" >
													</label>
											 	</section>
