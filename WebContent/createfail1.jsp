...
<ul>
		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<!-- breadcrumb -->
				<ol class="breadcrumb">
					<li>Administrator</li><li>create user</li>
				</ol>
				<!-- end breadcrumb -->
			...
			<div id="content">
				...
				<h2 style="color:red " >The user exists and input a different userid or try later! </h2>
				<!-- START ROW -->
					...
					<div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
								...
								<div>
									...
									<div class="widget-body no-padding">
										...
										<s:form action="student-create" class="smart-form">									
											...
											%>
												<section>
													...
													<label class="input">
														<input type="text" name="uid" value="<%= uid %>" class="input-sm">
													</label>
												</section>		
											  	<section>
											 	...
											 	<section>
													...
													<label class="input">
														<input type="text" name="email" value="<%= email %>" class="input-sm" >
													</label>
											 	</section>
