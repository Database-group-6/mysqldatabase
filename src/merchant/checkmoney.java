...
public class checkmoney {
  ...
  public String check()
  {
    ...
    listresult = mysql.queryByMid(loginID,startdate,finishdate);
  ...
  public String statistics()
  {
    ...
    income = mysql.queryInByMid(loginID,"0000-00-00",date);
    out = mysql.queryOutByMid(loginID, "0000-00-00", date);
    balance = income - out;
    Str = "success";
    return Str;
  }
